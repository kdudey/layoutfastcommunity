...
if (!function_exists('WriteDiscussion')) :
    ...
    function writeDiscussion($Discussion, &$Sender, &$Session) {
        ...
        ?>
        <div id="Discussion_<?php echo $Discussion->DiscussionID; ?>" class="<?php echo $CssClass; ?> col-lg-8 col-md-8">
            <div class="post pull-left">
                ...
                <div class="ItemContent Discussion">
                    ...
                    <div class="post-content pull-right">
                        ...
                        <div class="post-body">
                            <?php
                            if (strlen($DiscussionBody) > 150) {
                                echo substr($DiscussionBody, 0, 150) . "...";
                            } else {
                                echo $DiscussionBody;
                            }
                            ?>
                        ...
                        <div class="post-tags">
                            ...
                            if ($Sender->data('_ShowCategoryLink', true) && c('Vanilla.Categories.Use') && $Category) {
                                echo wrap(
                                    ...
                                    'span',
                                    array('class' => 'category-tag '.$Category['CssClass'])
                                );
                            }
            ...
            <div class="post-meta pull-right">
                <div class="Meta Meta-Discussion">
                    <div class="post-comment">
                        ...
                        <div class="post-comment-mark"></div>
                    </div>
                    <div class="post-view">
                        <?php
