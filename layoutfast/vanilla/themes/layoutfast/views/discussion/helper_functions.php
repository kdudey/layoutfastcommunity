...
if (!function_exists('writeComment')) :
    ...
    function writeComment($Comment, $Sender, $Session, $CurrentOffset) {
        ...
        <div class="row">
        <div id="<?php echo 'Comment_'.$Comment->CommentID; ?>" class="<?php echo $CssClass; ?> col-lg-12 col-md-12">
            <div class="post">
                <div class="Options">
                ...
                <div class="post-meta">
                    ...
                    <span class="MItem DateCreated">
                       <?php echo "on ". anchor(Gdn_Format::date($Comment->DateInserted, 'html'), $Permalink, 'Permalink', array('name' => 'Item_'.($CurrentOffset), 'rel' => 'nofollow')); ?>
                    </span>
                    <?php
