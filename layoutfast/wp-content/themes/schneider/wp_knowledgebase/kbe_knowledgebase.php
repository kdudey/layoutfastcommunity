        	...
        	<div class="col-md-8">
                ...
                <div class="content">
    				...
    				<div id="kbe_content" <?php echo $kbe_content_class; ?>>
			        	<?php if (get_the_title( KBE_PAGE_TITLE ) !== '') { ?>
			        		<h2><?php echo get_the_title( KBE_PAGE_TITLE ); ?></h2>
			        	<?php } ?>
			            ...
			            <div class="kbe_categories">
							...
							foreach ( $kbe_terms as $kbe_taxonomy ) {
								...
								$kbe_count_sum = $wpdb->get_var( "SELECT Sum(count) FROM {$wpdb->prefix}term_taxonomy WHERE taxonomy = '" . KBE_POST_TAXONOMY . "'And parent = $kbe_term_id" );
								...
								<div class="kbe_category">
				                    <h2>
				                        <a href="<?php echo get_term_link( $kbe_term_slug, 'kbe_taxonomy' ); ?>"><?php echo $kbe_term_name; ?></a>
				                        <span class="badge badge-pill badge-primary pull-right"><?php echo sprintf( _n( '%d Article', '%d Articles', $kbe_count_sum_parent, 'wp-knowledgebase' ), $kbe_count_sum_parent ); ?></span>
				                    </h2>
									...
									?>
										...
										?>
											<h3>
												<a href="<?php echo get_term_link( $kbe_child_term_slug, 'kbe_taxonomy' ); ?>"><?php echo $kbe_child_term_name; ?></a>
			                                    <span class="badge badge-pill badge-secondary pull-right"><?php echo sprintf( _n( '%d Article', '%d Articles', $kbe_child_term->count, 'wp-knowledgebase' ), $kbe_child_term->count ); ?></span>
			                                </h3>
